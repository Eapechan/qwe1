...
Every release must pass the security checklist in [docs/14-security-architecture.md](docs/14-security-architecture.md) §17. Security fixes are released as PATCH (or MINOR if a feature is involved) and announced via GitHub Security Advisories.
